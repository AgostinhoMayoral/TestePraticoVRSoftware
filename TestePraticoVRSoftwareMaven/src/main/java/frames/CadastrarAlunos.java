...
public class CadastrarAlunos extends javax.swing.JFrame {
    ...
    Conectadb conexoesDBObj = new Conectadb();
    Connection con = null;
    Statement stmt = null;
    ResultSet rs = null;
    ...
    public CadastrarAlunos() throws ClassNotFoundException {
        ...
        listaCursos = conexoesDBObj.selectListaCursosDB();
        for (Curso u : listaCursos) {
            cursosComboBox.addItem(u.getDescricao());
        }
    ...
    private void initComponents() {
        ...
        editaAlunoButton1.setText("Voltar");
